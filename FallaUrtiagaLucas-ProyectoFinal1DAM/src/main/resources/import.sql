...
INSERT INTO Libro(id_libro, titulo, imagen_portada, texto_alt_portada, serie, precio, stock, autor, editorial, descripcion, fecha_publicacion, num_paginas, cubierta, publico, tipo_id_tipo) VALUES (15, 'Maximum Berserk vol.21', 'https://i.redd.it/fti2eq2bz6mb1.jpg', 'Portada Maximum Berserk vol.21', 'Maximum Berserk', 24.99, 50, 'Kentaro Miura', 'Panini Comics', 'Una de las más aclamadas series mangas de todos los tiempos. Un viaje épico y salvaje a un reino de fantasía. Guts es un guerrero vestido de negro que porta una gigantesca espada más larga que su propia estatura y un robusto brazo ortopédico de hierro...', '2029-09-21 00:00:00', 452, 'Sobrecubierta', 'Adulto', 1);
